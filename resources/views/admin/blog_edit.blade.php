    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <form class="form-horizontal" action="{{ route('blog.edit') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <fieldset>
                        <div class="control-group">
                            <label class="control-label" for="date01">Blog Name</label>
                            <div class="controls">
                                <input type="text" name="name" value="{{ $blog->name }}" class="input-xlarge">
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea class="cleditor" name="long_description" rows="3">{{ $blog->long_description }}</textarea>
                            </div>
                        </div>
